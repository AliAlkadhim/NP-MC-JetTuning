...
namespace Rivet {
  ...
  public:
     ...
     /// Constructor
     RIVET_DEFAULT_ANALYSIS_CTOR(RivetNtupliser_CMS_2021_I1972986);

     void init() {

       file = TFile::Open("RivetNtupliser_CMS_2021_I1972986_output.root", "RECREATE");
  ...
  RIVET_DECLARE_PLUGIN(RivetNtupliser_CMS_2021_I1972986);
